...
\begin{definition}[Time-triggered cause-effect chain]
...
\Tool assumes that each task can satisfy its deadline or LET.
...
\paragraph{Maximum End-to-End Latencies}
